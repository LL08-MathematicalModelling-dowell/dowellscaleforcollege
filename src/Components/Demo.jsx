...
export default function Demo() {
    ...
    return (
        <div>
            <div className="w-full flex flex-col justify-center items-center text-[18px] font-bold text-red-500 p-2">
            ...
            <div className="flex flex-col justify-center items-center w-full mt-3 gap-6 sm:gap-2">
                {questions.map((question, index) => (
                    <div key={index} className="flex flex-col justify-center items-center w-full mb-4 ">
                        <div className="flex justify-start items-center gap-2 sm:gap-8 w-[100%] lg:w-[80%]  px-4">
